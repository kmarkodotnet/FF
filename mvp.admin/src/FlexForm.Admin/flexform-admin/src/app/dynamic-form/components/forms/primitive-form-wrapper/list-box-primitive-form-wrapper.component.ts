...
export class ListBoxPrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<ListBoxFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(ListBoxFormComponent);
  }
}

...
import { MoneyFormComponent } from '../primitive-form/money-form/money-form.component';
...
export class MoneyPrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<MoneyFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(MoneyFormComponent);
  }
}

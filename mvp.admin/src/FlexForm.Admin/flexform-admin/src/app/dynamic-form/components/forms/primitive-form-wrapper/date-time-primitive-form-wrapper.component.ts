...
import { DateTimeFormComponent } from '../primitive-form/date-time-form/date-time-form.component';
...
export class DateTimePrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<DateTimeFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(DateTimeFormComponent);
  }
}

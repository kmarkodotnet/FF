...
import { RadioButtonFormComponent } from '../primitive-form/radio-button-form/radio-button-form.component';
...
export class RadioButtonPrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<RadioButtonFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(RadioButtonFormComponent);
  }
}

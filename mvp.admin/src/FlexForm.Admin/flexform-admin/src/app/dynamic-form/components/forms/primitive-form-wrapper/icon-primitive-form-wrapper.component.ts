...
import { IconFormComponent } from '../primitive-form/icon-form/icon-form.component';
...
export class IconPrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<IconFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(IconFormComponent);
  }
}

...
export class AutoCompleteBoxPrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<AutoCompleteBoxFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(AutoCompleteBoxFormComponent);
  }
}

...
import { DocumentDownloadFormComponent } from '../primitive-form/document-download-form/document-download-form.component';
...
export class DocumentDownloadPrimitiveFormWrapperComponent extends PrimitiveFormWrapperComponent<DocumentDownloadFormComponent>{
  ...
  getComponentFactory():any{
    return this.componentFactoryResolver.resolveComponentFactory(DocumentDownloadFormComponent);
  }
}

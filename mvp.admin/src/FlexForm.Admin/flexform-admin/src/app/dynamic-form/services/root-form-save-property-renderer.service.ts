...
export class RootFormSavePropertyRendererService  extends BasePropertiesService implements PropertyRendererInterface{
  context: any;
  renderValue(uiProperties: BaseProperty<any>[]): string {
    return super.getValue(uiProperties,PropertyNameConstants.ROOT_FORM_SAVE);
  }

...
export class LabelTextPropertyRendererService extends BasePropertiesService implements PropertyRendererInterface{
  context: any;
  renderValue(uiProperties: BaseProperty<any>[]): string {
    return super.getValue(uiProperties,PropertyNameConstants.LABEL_TEXT);
  }

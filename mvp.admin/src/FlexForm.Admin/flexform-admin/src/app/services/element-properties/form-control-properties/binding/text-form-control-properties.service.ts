...
export class TextFormControlPropertiesService extends FormControlBindingPropertiesService {
  ...
  constructor(protected propertyServicePool:FormControlPropertyServicePool, protected templatePropertiesServiceFactory:TemplatePropertiesServiceFactory) {
    ...
    async createProperties(formControl: FormControl): Promise<BaseProperty<any>[]> {
      ...
      bps.push(new NumberProperty(formControl.guid,PropertyNameConstants.MAX_CHARS,10,false,false));
      return bps;
    }
    ...
    async loadProperties(formControl: FormControl,uiProperties: BaseProperty<any>[]): Promise<void> {
      ...
      formControl.uiProperties.push(new NumberProperty(formControl.guid,PropertyNameConstants.MAX_CHARS,this.getValue(uiProperties,PropertyNameConstants.MAX_CHARS),false,false));
    }
}

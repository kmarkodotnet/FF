...
export class FormControlHorizontalAlignmentService implements LowLevelPropertyService {
  async createProperty(guid: Guid, defaultValue: any, filterProperty?: any): Promise<BaseProperty<any>> {
    ...
    let horizontalAlignments = this.constantsService.getHorizontalAlignments();
    horizontalAlignments.forEach(e => dropDownElements.push(new DropDownElement(e,this.constantsService.getHorizontalAlignmentName(e))));
  ...
  getName():string{
    return PropertyNameConstants.LABEL_HPOS;
  }
